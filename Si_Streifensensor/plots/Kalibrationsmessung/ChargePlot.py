...
plt.xlabel(r'Elektronenpuls [MeV]',fontsize=10)
plt.ylabel(r'ADCC',fontsize=10)
plt.title(r'Streifen 50',fontsize=10)
plt.subplot(2,2,2)
plt.plot(e_70/1e6*3.6, adc_70, color='darkblue')
plt.title(r'Streifen 70',fontsize=10)
plt.xlabel(r'Elektronenpuls [MeV]',fontsize=10)
plt.ylabel(r'ADCC',fontsize=10)
plt.subplot(2,2,3)
plt.plot(e_80/1e6*3.6, adc_80, color='darkblue')
plt.title(r'Streifen 80',fontsize=10)
plt.xlabel(r'Elektronenpuls [MeV]',fontsize=10)
plt.ylabel(r'ADCC',fontsize=10)
plt.subplot(2,2,4)
plt.plot(e_90/1e6*3.6, adc_90, color='darkblue')
plt.title(r'Streifen 90',fontsize=10)
plt.xlabel(r'Elektronenpuls [MeV]',fontsize=10)
plt.ylabel(r'ADCC',fontsize=10)
plt.savefig('Kalib_Kanal_Plot.pdf',fontsize=10)
plt.clf()
...
plt.xlabel(r'Elektronenpuls [MeV]')
plt.ylabel(r'ADCC')
plt.legend()
...
plt.ylabel(r'Elektronenpuls [MeV]')
plt.xlabel(r'ADCC')
