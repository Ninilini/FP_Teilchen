...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Strom-Spannungs-Kennlinie/Kennlinie.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Pedestals & Noise/Pedestals_Noise.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Pedestals & Noise/CommonModeShift.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Kalibrationsmessung/Delay.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Kalibrationsmessung/0V_80V_Vergleich.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Kalibrationsmessung/Kalib_Kanal_Plot.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Kalibrationsmessung/Kalibrationsregression.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Vermessung Laser/Delay.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Vermessung Laser/Position_Kanal_Signal_Plot.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Vermessung Laser/Maxima.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/CCE Laser/Kennlinie.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/CCE Quelle/Effizienz.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Großer Quellenscan/Cluster.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Großer Quellenscan/hitmap.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Großer Quellenscan/spectrum_adc.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../Auswertung/Großer Quellenscan/spectrum_keV.pdf}
