...
size_Hfkt = np.genfromtxt('plots/Grosser_Quellenscan/cluster_size.txt', unpack=True)
number_Hfkt = np.genfromtxt('plots/Grosser_Quellenscan/number_of_clusters.txt', unpack=True)
