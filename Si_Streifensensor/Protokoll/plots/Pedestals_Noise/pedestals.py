...
daten=pd.read_csv('plots/Pedestals_Noise/Pedestal.txt', encoding='utf-8', comment='#', sep=';')
...
plt.savefig('plots/Pedestals_Noise.pdf')
#plt.show()
plt.clf()
...
plt.legend()
plt.savefig('plots/CommonModeShift.pdf')
plt.show()
