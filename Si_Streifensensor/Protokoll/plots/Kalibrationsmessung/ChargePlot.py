...
#Daten einlesen
e_50, adc_50 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K50_85V.txt', unpack=True)
e_60, adc_60 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K60_85V.txt', unpack=True)
e_70, adc_70 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K70_85V.txt', unpack=True)
e_80, adc_80 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K80_85V.txt', unpack=True)
e_90, adc_90 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K90_85V.txt', unpack=True)
e_60_0, adc_60_0 = np.genfromtxt('plots/Kalibrationsmessung/Charge_K60_0V.txt', unpack=True)
...
plt.xlabel(r'$Elektronenpuls\;[\mathrm{MeV}]$')
plt.ylabel(r'$ADCC$')
plt.savefig('plots/Kalib_Kanal_Plot.pdf')
#plt.show()
plt.clf()
...
plt.ylabel(r'$ADCC$')
plt.legend()
plt.savefig('plots/0V_80V_Vergleich.pdf')
#plt.show()
plt.clf()
...
plt.legend()
plt.savefig('plots/Kalibrationsregression.pdf')
plt.show()
